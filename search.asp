...
if (FormFormat > 0) then
	' Insert the form
	OutBuf(OUTPUT_FORM_SEARCHBOX) = OutBuf(OUTPUT_FORM_SEARCHBOX) & STR_FORM_SEARCHFOR & " <input type=""text"" name=""zoom_query"" size=""35"" value=""" & htmlspecialchars(query) & """ id=""zoom_searchbox"" class=""zoom_searchbox"" autocorrect=""off"" autocapitalize=""off"" />" & VbCrlf
